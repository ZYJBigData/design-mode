...
public class RocksDBTest {
    ...
    public void test() throws RocksDBException {
        System.out.println("0,index value==" + getLastIndex());
        System.out.println("null,cmd value==" + get(getLastIndex()));

        write(new Cmd("hello", "value"));

        System.out.println("1,index value==" + getLastIndex());

        System.out.println("[hello value] ===" + get(getLastIndex()));
