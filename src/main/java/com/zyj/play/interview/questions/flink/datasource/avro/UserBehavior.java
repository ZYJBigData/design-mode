...
public class UserBehavior extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6841772424080677596L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserBehavior\",\"namespace\":\"com.zyj.play.interview.questions.flink.datasource.avro\",\"fields\":[{\"name\":\"userId\",\"type\":\"long\"},{\"name\":\"itemId\",\"type\":\"long\"},{\"name\":\"categoryId\",\"type\":\"int\"},{\"name\":\"behavior\",\"type\":\"string\"},{\"name\":\"timestamp\",\"type\":\"long\"}]}");
   ...
   */
  public static com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder newBuilder() {
    return new com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder();
  }
   ...
   * @return A new UserBehavior RecordBuilder
   */
  public static com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder newBuilder(com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder other) {
    return new com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder(other);
  }
   ...
   * @return A new UserBehavior RecordBuilder
   */
  public static com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder newBuilder(com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior other) {
    return new com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserBehavior>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder setUserId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder setItemId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder clearItemId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder setCategoryId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder clearCategoryId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder setBehavior(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder clearBehavior() {
      behavior = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zyj.play.interview.questions.flink.datasource.avro.UserBehavior.Builder clearTimestamp() {
