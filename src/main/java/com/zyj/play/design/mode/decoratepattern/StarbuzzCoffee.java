...
import com.zyj.play.design.mode.decoratepattern.decorator.Milk;
...
public class StarbuzzCoffee {
    public static void main(String[] args) {
        ...
        System.out.println(bea.getDescription() + " $ " + bea.getPrice());

        //制作一杯darkRoast对象
        Beverage bea1 = new DarkRoast();
        System.out.println(bea1.getDescription() + " $ " + bea1.getPrice());
        bea1 = new Mocha(bea1);
        System.out.println(bea1.getDescription() + " $ " + bea1.getPrice());
        bea1 = new Whip(bea1);
        System.out.println(bea1.getDescription() + " $ " + bea1.getPrice());
